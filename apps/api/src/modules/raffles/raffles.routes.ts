  ...
  app.post('/raffles', { preHandler: requireRifero }, async (request, reply) => {
    ...
    const raffle = await prisma.raffle.create({
      data: {
        ...
        priceListRows: data.priceListRows ?? 10,
        manualSelection: data.manualSelection ?? true,
  ...
  app.patch('/raffles/:id', { preHandler: requireRifero }, async (request) => {
    ...
    await prisma.raffle.update({
      ...
      data: {
        ...
        ...(rest.manualSelection !== undefined ? { manualSelection: rest.manualSelection as boolean } : {}),
        ...(rest.comingSoon !== undefined ? { comingSoon: rest.comingSoon as boolean } : {}),
